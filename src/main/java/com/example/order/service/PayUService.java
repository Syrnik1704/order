...
import com.example.order.mappers.OrderItemsToPayUProductMapper;
...
public class PayUService {
    ...
    private final OrderItemsToPayUProductMapper orderItemsToPayUProductMapper;
    ...
    @Value("${payu.url.notify}")
    private String payu_url_notify;
    ...
    private PayUOrder prepareOrder(Order order, List<OrderItems> items) {
        ...
        List<PayUProduct> product = items.stream().map(orderItemsToPayUProductMapper::mapToPayUProduct).toList();
